...
<body>
	...
	<header id="header">
		<div class="container clearfix">
			<div id="logo-wrap">
				<h1 id="logo"><a href="index.php"><img src="images/" alt=""></a></h1>
			</div>
				...
				<nav id="nav">
					<ul class="sf-menu">
						...
						<?php if($user_role == 'admin' || $user_role == 'petugas'): ?>
							<li><a href="list-atlet.php">Konten kreator</a>
								<ul>
									<li><a href="list-atlet.php">Daftar Konten Kreator</a></li>
									<li><a href="tambah-atlet.php">Tambah Konten Kreator</a></li>
								</ul>
							</li>
						<?php endif; ?>
